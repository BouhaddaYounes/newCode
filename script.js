...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Load tasks
    fetch('http://localhost:5501/api/getAll', {
        headers: {
  ...
  searchBtn.onclick = function() {
    ...
    authenticatedFetch('http://localhost:5501/api/search/' + searchValue)
    .then(response => response.json())
    .then(data => loadHTMLTable(data['data']));
  }
  
  function deleteRowById(id) {
    authenticatedFetch('http://localhost:5501/api/delete/' + id, {
        method: 'DELETE'
    })
    .then(response => response.json())
    .then(data => {
  ...
  updateBtn.onclick = function() {
    ...
    authenticatedFetch('http://localhost:5501/api/update', {
        method: 'PATCH',
        headers: {
  ...
  addBtn.onclick = function () {
    ...
    authenticatedFetch('http://localhost:5501/api/insert', {
        headers: {
            'Content-type': 'application/json'
        },
        method: 'POST',
